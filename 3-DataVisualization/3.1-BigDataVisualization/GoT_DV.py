# -*- coding: utf-8 -*-
"""
Created on Sun May  5 22:58:38 2019
...
def get_data(file_name, label_name, test_percent, drop_rows = 0):
	dataframe_all = pd.read_csv(file_name, index_col=False )
	...
	dataframe_all = dataframe_all.iloc[:,:]
